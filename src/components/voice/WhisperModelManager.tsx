...
import { Download, Trash2, X, Loader2, HardDrive, Mic, CircleStop, CheckCircle2 } from 'lucide-react';
...
export function WhisperModelManager({ selectedModel, onSelect }: Props) {
  ...
  return (
    <div className="space-y-1.5">
      ...
      {/* Setup status */}
      {hasDownloaded ? (
        <div className="rounded-lg border border-emerald-500/20 bg-emerald-500/5 px-3 py-2.5 mb-3 text-[11.5px] text-emerald-400 leading-relaxed">
        ...
        <div className="rounded-lg border border-border bg-bg px-3 py-2.5 mb-3 text-[11.5px] text-text-muted leading-relaxed">
          Pick a model below and download it. Parakeet is recommended for best accuracy. Everything runs locally, no external tools needed.
        </div>
      )}
